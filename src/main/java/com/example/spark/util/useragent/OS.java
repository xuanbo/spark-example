...
public class OS {
    ...
    /**
     * Yammer Mobile Special Case
     */
    public static final Pattern YpodPattern = Pattern.compile("iPod touch[\\s\\;]+iPhone.*os (\\d+)[._](\\d+)", Pattern.CASE_INSENSITIVE);

    /**
     * Yammer Mobile Special Case
     */
    public static final Pattern YpadPattern = Pattern.compile("iPad[\\s\\;]+iPhone.*os (\\d+)[._](\\d+)", Pattern.CASE_INSENSITIVE);

    /**
     * Yammer Mobile Special Case
     */
    public static final Pattern YphonePattern = Pattern.compile("iPhone[\\s\\;]+iPhone.*os (\\d+)[._](\\d+)", Pattern.CASE_INSENSITIVE);
